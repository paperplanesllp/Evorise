  ...
  return (
    <footer className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,#d9f7e5_0%,transparent_32%),radial-gradient(circle_at_top_right,#f7e1ff_0%,transparent_28%),linear-gradient(135deg,#f8fff9_0%,#fff8ef_45%,#f8f7ff_100%)] px-6 py-16 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 rounded-[32px] border border-slate-300/40 bg-white/80 p-8 shadow-2xl shadow-slate-200/70 backdrop-blur-xl lg:grid-cols-[1.4fr_1fr_1fr_1.2fr] lg:p-12">
          <div className="space-y-6">
            ...
            <p className="max-w-xl text-base leading-8 text-slate-600">
              Creating confident traders through structured forex education, live
              market exposure, and practical mentorship.
            </p>
          </div>
          ...
          <div className="rounded-[28px] border border-slate-200/70 bg-slate-50/90 p-6 shadow-sm shadow-slate-200/50">
            ...
            <div className="mt-6 space-y-4 text-sm leading-7 text-slate-600">
              ...
              <div>
                ...
                <a href="tel:+910000000000" className="transition hover:text-teal-800">
                  +91 0000000000
                </a>
              </div>
            </div>
