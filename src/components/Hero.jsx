  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1800px] text-center">
        <div className="mx-auto flex max-w-[1600px] flex-wrap justify-center gap-8 text-5xl font-bold leading-none tracking-tight md:text-7xl lg:flex-nowrap lg:gap-16 lg:text-[105px]">
          <span
        ...
        <div className="mt-16 inline-flex items-center gap-4 rounded-full border border-black/5 bg-white/90 px-8 py-4 text-base font-bold text-slate-700 shadow-lg backdrop-blur-sm">
          ...
          <span>The Best Trading Solution for You</span>
          <span className="h-3 w-3 rounded-full bg-teal-700" />
        </div>
        ...
        <p className="mx-auto mt-10 max-w-3xl text-lg leading-9 text-slate-600 md:text-[22px]">
          We provide expert guidance in forex trading, risk management, and
          market strategies to help you trade with confidence and consistency.
        </p>
